...
public class Car {
    ...
    void setDriver(Person person) {
        if (person.getAge() > 17) {
            this.driver = person;
            System.out.println(person+" kjører nå bilen.");
        }
        else {
            throw new IllegalArgumentException(person + "Er ikke gammel nok til å kjøre. Buhu.");
        }
    }
    ...
    public int getTotalAge() {
        ...
        return total; // Må jo endres, bare for at det skal returnere noe.
    }
